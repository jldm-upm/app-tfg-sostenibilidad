<template>
  <div id='outline-container-org5bdc21b' class='outline-2'>
    <h2 id='org5bdc21b'><span class='section-number-2'>1</span> Política de Privacidad</h2>
    <div class='outline-text-2' id='text-1'>
    </div>
    <div id='outline-container-orga5db39c' class='outline-3'>
      <h3 id='orga5db39c'><span class='section-number-3'>1.1</span> La entidad responsable del tratamiento de los datos es 'X'.</h3>
    ...
    <div id='outline-container-orgdcf546d' class='outline-3'>
      <h3 id='orgdcf546d'><span class='section-number-3'>1.2</span> Acceso por la aplicación a recursos del teléfono móvil</h3>
      <div class='outline-text-3' id='text-1-2'>
        ...
        <ul class='org-ul'>
          <li>Acceso a la ubicación o localización del dispositivo, que se pedirá
            para mostrar y poder utilizar la funcionalidad de mapas.</li>

          <li>Acceso a la cámara  para poder escanear códigos de productos.</li>
        </ul>
    ...
    <div id='outline-container-orgf87e76f' class='outline-3'>
      <h3 id='orgf87e76f'><span class='section-number-3'>1.3</span> Derechos de los usuarios</h3>
    ...
    <div id='outline-container-org1468ada' class='outline-3'>
      <h3 id='org1468ada'><span class='section-number-3'>1.4</span> Medidas de seguridad adoptadas por 'X'</h3>
