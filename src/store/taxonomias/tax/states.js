export const states =
{
  ...
  'en:expiration-date-completed': {
    name: {
      ...
      nl: 'Houdbaarheidsdatum ingevuld',
  ...
  'en:packaging-code-to-be-completed': {
    name: {
      ...
      de: 'Verpackungscode auszufüllen',
      en: 'Packaging code to be completed',
