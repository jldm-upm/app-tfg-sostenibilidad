export const countries =
{
  ...
  'en:saint-martin': {
    ...
    name: {
      ...
      it: 'Saint-Martin',
      nb: 'Saint-Martin',
      oc: 'Collectivitat de Sant Martin',
      eu: 'Saint Martin',
      pt: 'São Martinho',
      az: 'Sent Martin',
      bg: 'Сен Мартен',
  ...
  'en:nakhchivan-autonomous-republic': {
    ...
    name: {
      ...
      ms: 'Nakhichevan',
      cv: 'Начихевань автономи республики',
      sh: 'Nahčivan',
      kk: 'Нахшыван',
      sl: 'Nahičevan',
      vi: 'Nakhchivan',
  ...
  'en:saint-pierre-and-miquelon': {
    ...
    name: {
      ...
      ug: 'ساينت پىئېر ئارىلى ۋە مىكېلون تاقىم ئاراللىرى',
      ...
      gl: 'San Pedro e Miguelón - Saint Pierre et Miquelon',
  ...
  'en:british-virgin-islands': {
    ...
    name: {
      ...
      tl: 'Kapuluang Birheng Britaniko',
  ...
  'en:saint-helena': {
    ...
    name: {
      ...
      ru: 'Острова Святой Елены',
      be: 'Астравы Святой Алены',
      hu: 'Szent Ilona',
  ...
  'en:british-indian-ocean-territory': {
    ...
    name: {
      ...
      os: 'Индийы фурды Британийы территори',
      ...
      bs: 'Britanske indijskookeanske teritorije',
      fr: "Territoire britannique de l'océan Indien",
      br: 'Tiriad Meurvor Indez Breizh-Veur',
      fa: 'قلمرو بریتانیا در اقیانوس هند',
      su: 'Téritori Samudra Hindia Britania',
      an: "Territorio Britanico de l'Ocián Indico",
  ...
  'en:heard-island-and-mcdonald-islands': {
    name: {
      ...
      ta: 'ஏர்ட் தீவும் மக்டொனால்ட் தீவும்',
      sh: 'Otok Heard i otočje McDonald',
      ...
      mn: 'Хэрд Арал ба Макдоналд Арлууд',
  ...
  'en:south-africa': {
    ...
    languages: {
      en: 'en,zu,xh,af,ve,ss,tn,ts,st,nr'
    },
    name: {
      io: 'Sud-Afrika',
  ...
  'en:iraqi-kurdistan': {
    name: {
      ...
      br: 'Kurdistan Irak',
      su: 'Kurdistan Irak',
      hy: 'Իրաքյան Քուրդիստան',
      sh: 'Irački Kurdistan',
      ms: 'Wilayah Kurdistan Iraq',
      ta: 'ஈராக்கிய குர்திஸ்தான்',
      cs: 'Irácký Kurdistán',
      sr: 'Јужни Курдистан',
      fi: 'Irakin Kurdistan',
      ...
      nn: 'Kurdistan i Irak',
      es: 'Kurdistán iraquí',
      sv: 'Irakiska Kurdistan',
      eo: 'Aŭtonoma Regiono Kurdistano',
      en: 'Iraqi Kurdistan',
      ku: 'Başûrê Kurdistanê',
      th: 'เขตปกครองตนเองเคอร์ดิสถานแห่งอิรัก',
      ca: 'Kurdistan Iraquià',
  ...
  'en:european-union': {
    ...
    languages: {
      en: 'en,es,fi,fr,de,pt,it,hr,nl,ro,bg,pl,sv,da,cs,sk,sl,hu,et,lv,lt,el,ga,mt'
    }
  },
  'en:cote-d-ivoire': {
    name: {
  ...
  'en:wallis-and-futuna': {
    ...
    name: {
      ...
      cs: 'Wallis a Futuna',
      sk: 'Wallis a Futuna',
      ug: 'ۋاللىس ۋە فۇتۇنا تاقىم ئاراللىرى',
      sh: 'Wallis i Futuna',
  ...
  'en:french-southern-and-antarctic-lands': {
    ...
    name: {
      ...
      an: 'Territorios Australs Franceses',
      ...
      yo: 'Àwọn Agbègbè Apágúúsù àti Antárktìkì Fránsì',
      ta: 'பிரெஞ்சு தென்னக நிலங்களும் அண்டார்க்டிக் நிலமும்',
      ...
      eo: 'Francaj Sudaj kaj Antarktaj Teritorioj',
      en: 'French Southern and Antarctic Lands',
      ...
      mr: 'फ्रान्सचे दक्षिणी व अंटार्क्टिक भूभाग',
