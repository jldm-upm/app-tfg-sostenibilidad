<template>
        ...
        <li><a id='org21ef186'></a>Acceso a la funcionalidad<br />
          <div class='outline-text-4' id='text-2-1-2'>
            <p>
              ...
              la <b>barra de herramientas</b> que se encuentra en la parte superior del
              programa.
            </p>
          </div>
              ...
              <ol class='org-ol'>
                ...
                <li><a id='org7180b89'></a><q-icon name='person_add' size='md'/> Crear usuario<br />
                  <div class='outline-text-6' id='text-2-1-2-4-2'>
                    ...
                    <ul class='org-ul'>
                      ...
                      <li>Introducir una contraseña de al menos ocho caracteres.</li>
                ...
                <li><a id='org2902936'></a><q-icon name='configuration' size='md'/> Configuración<br />
                  <div class='outline-text-6' id='text-2-1-2-4-3'>
                    ...
                    <ul class='org-ul'>
                      <li><b>Almacenar en servidor</b>: Sólo estará disponible cuando este
                        iniciada una sesión, almacena los datos de usuario:
                        configuración y valoraciones. Estos datos se cargarán en la
                        aplicación cada vez que el usuario inicie una sesión.</li>
                      <li><b>Lenguaje</b>: El idioma de la interfaz de usuario.</li>
                      <li><b>URL del Servicio</b>: La aplicación puede usarse con otros
                        servicios compatibles.</li>
                      <li><b>Tamaño del Historial</b>: Máximo número de productos previamente
                        consultados que se almacenarán para poder volver a ser
                        consultados.</li>
                      <li><b>Tamaño de Página</b>: Máximo número de productos que se
                        devolverá en una consulta.</li>
                      <li><b>Parámetros de Sostenibilidad</b>: Para cada punto de
                  ...
                  <ol class='org-ol'>
                    <li><a id='orgf68b9dc'></a>NOTA SOBRE SEGURIDAD<br />
                ...
                <li><a id='orgd75615d'></a>Información del producto<br />
                  <div class='outline-text-6' id='text-2-1-2-5-2'>
                    ...
                    <ul class='org-ul'>
                      ...
                      <li><span class='underline'>Vegetariano</span>: Indicado mediante la abreviatura <b>Vt</b>. Será de
  ...
  <div id='outline-container-orgbf6231f' class='outline-2'>
    <h2 id='orgbf6231f'><span class='section-number-2'>3</span> Condiciones</h2>
    <div class='outline-text-2' id='text-3'>
    </div>
    <div id='outline-container-org1b78dba' class='outline-3'>
      <h3 id='org1b78dba'><span class='section-number-3'>3.1</span> Licencia de la base de datos y contenidos de Open Food Facts</h3>
